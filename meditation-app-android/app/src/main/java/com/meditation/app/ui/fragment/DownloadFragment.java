...
public class DownloadFragment extends ListFragment {
    ...
    private static final int RESULT_OK= 002;
  ...
  {
      btnDownload = (Button)rootView. findViewById(R.id.buttonDownload);
      btnPause = (Button) rootView.findViewById(R.id.buttonPause);
      btnResume = (Button)rootView. findViewById(R.id.buttonResume);
      btnCancel = (Button)rootView. findViewById(R.id.buttonCancel);
      btnDelete = (Button)rootView. findViewById(R.id.buttonDelete);
      btnPauseAll = (Button)rootView. findViewById(R.id.buttonPauseAll);
      btnCancelAll = (Button)rootView. findViewById(R.id.buttonCancelAll);
    ...
    private void initUI() {
         ...
         */
        simpleAdapter = new SimpleAdapter(getActivity(), transferRecordMaps,
        ...
        btnDownload.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(getActivity(), DownloadSelectionFragment.class);
    ...
    private void beginDownload(String key) {
        ...
        TransferObserver observer = transferUtility.download(Constants.FULL_VERSION_BUCKET_NAME, key, file);
